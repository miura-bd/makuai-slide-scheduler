...
Google スライドを埋め込むだけの HTML 1枚で、サーバーもビルドも不要です。Raspberry Pi を HDMI に繋いでキオスク表示する用途を想定しています。
...
`index.html` をブラウザで開きます。まだ何も登録されていなければセットアップ画面が出るので、案内に従ってスケジュールを登録してください。
